...
Public Sub ShowStatus() 'Updating the cars properties
    ...
    frmStatus.lblStatusSpeed1.Caption = "Speed : " & CInt(1000 / frmIntersection.tmrBlueCar.Interval) & " чо""щ"
    ...
    frmStatus.lblStatusSpeed2.Caption = "Speed : " & CInt(1000 / frmIntersection.tmrFireCar.Interval) & " чо""щ"
    ...
    frmStatus.lblStatusSpeed3.Caption = "Speed : " & CInt(1000 / frmIntersection.tmrRedCar.Interval) & " чо""щ"
    ...
    frmStatus.lblStatusSpeed4.Caption = "Speed : " & CInt(1000 / frmIntersection.tmrWhiteCar.Interval) & " чо""щ"
    ...
    frmStatus.lblStatusSpeed5.Caption = "Speed : " & CInt(1000 / frmIntersection.tmrBlackCar.Interval) & " чо""щ"
    ...
    frmStatus.lblStatusSpeed6.Caption = "Speed : " & CInt(1000 / frmIntersection.tmrGreenCar.Interval) & " чо""щ"
    ...
    frmStatus.lblStatusSpeed7.Caption = "Speed : " & CInt(1000 / frmIntersection.tmrYellowCar.Interval) & " чо""щ"
    ...
    frmStatus.lblStatusSpeed8.Caption = "Speed : " & CInt(1000 / frmIntersection.tmrTruckCar.Interval) & " чо""щ"
