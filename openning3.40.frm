...
'-----------------------------------------------------------------
 ...
 '--------------------------------------------------------------------
    lblSpeed(BlueCar).Caption = "מהירות : " & CInt(1000 / frmIntersection.tmrBlueCar.Interval) & " קמ""ש"
    lblSpeed(FireCar).Caption = "מהירות : " & CInt(1000 / frmIntersection.tmrFireCar.Interval) & " קמ""ש"
    lblSpeed(RedCar).Caption = "מהירות : " & CInt(1000 / frmIntersection.tmrRedCar.Interval) & " קמ""ש"
    lblSpeed(WhiteCar).Caption = "מהירות : " & CInt(1000 / frmIntersection.tmrWhiteCar.Interval) & " קמ""ש"
    lblSpeed(BlackCar).Caption = "מהירות : " & CInt(1000 / frmIntersection.tmrBlackCar.Interval) & " קמ""ש"
    lblSpeed(GreenCar).Caption = "מהירות : " & CInt(1000 / frmIntersection.tmrGreenCar.Interval) & " קמ""ש"
    lblSpeed(YellowCar).Caption = "מהירות : " & CInt(1000 / frmIntersection.tmrYellowCar.Interval) & " קמ""ש"
    lblSpeed(TruckCar).Caption = "מהירות : " & CInt(1000 / frmIntersection.tmrTruckCar.Interval) & " קמ""ש"
